...
public class NRMExt : NetworkRoomManager
{
    ...
    /// </summary>
    [SerializeField] string relayJoinCode = "";
    private UtpTransport _utpTransport;
    [SerializeField] private int maxPlayers = 4;
    [SerializeField] private string regionId = null; 
    ...
    /// <summary>
    /// Method UnityLogin
    /// Init session in unity services
    /// </summary>
    ...
    public void StartRelayHost()
    {
        ...
        _utpTransport.AllocateRelayServer(maxPlayers,regionId, 
            (string joinCode) =>
        {
    ...
    public void StartRelayClient()
    {
        ...
        _utpTransport.ConfigureClientWithJoinCode(relayJoinCode,
            ...
            () =>
            {
                UtpLog.Error($"Failed to start a Relay client.");
            });
    }
